...
epochs = 100
Epoch = 100
#Manual overide to make sure all epochs are 100
...
if __name__ == '__main__':
    ...
    for epoch in range(17): #last_epoch + 1, args.num_epochs
        train(train_loader, net, criterion, optimizer, device=DEVICE, debug_steps=args.debug_steps, epoch=epoch) #Force 100
        scheduler.step()
